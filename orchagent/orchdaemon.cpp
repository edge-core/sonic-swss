...
bool OrchDaemon::init()
{
    ...
    vector<table_name_with_pri_t> nat_tables = {
        { APP_NAT_UPDATE_EVENT_TABLE_NAME,  natorch_base_pri + 6 },
     ...
     */
    m_orchList = { gSwitchOrch, gCrmOrch, gPortsOrch, gBufferOrch, gFlowCounterRouteOrch, gIntfsOrch, gNeighOrch, gNhgMapOrch, gNhgOrch, gCbfNhgOrch, gRouteOrch, gCoppOrch, gQosOrch, wm_orch, gPolicerOrch, tunnel_decap_orch, sflow_orch, gDebugCounterOrch, gMacsecOrch, gBfdOrch, gSrv6Orch, mux_orch, mux_cb_orch, gMonitorOrch, gStpOrch};
    ...
    */
    ...
    } else if (platform == CISCO_8000_PLATFORM_SUBSTRING)
    {
        ...
        m_orchList.push_back(new PfcWdSwOrch<PfcWdSaiDlrInitHandler, PfcWdActionHandler>(
                    ...
                    queueAttrIds,
                    PFC_WD_POLL_MSECS));
    } else if (platform == XS_PLATFORM_SUBSTRING)
    {
        static const vector<sai_port_stat_t> portStatIds =
        {
            SAI_PORT_STAT_PFC_0_RX_PKTS,
